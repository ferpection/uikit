...
storiesOf('Iconography|FontAwesomeIcon', module)
  ...
  .add('exposed component', () => (
    <>
      ...
      <p><code>{FontAwesomeIcon.name}</code> is not part of UiKit. As UiKit uses it in production mode and to avoid loaded several version of font awesome in you application, UiKit exposes this component to your application.</p>
      <p>For help about how to use the component, please refer to <a href="https://www.npmjs.com/package/@fortawesome/react-fontawesome">the documentation</a></p>
      <p>For instance:</p>
      <h2>Solid</h2>
      ...
      <p>For more icons, please refer to the <a href="https://fontawesome.com/icons?d=gallery&s=solid">Solid icon gallery</a></p>
      <h2>Regular</h2>
      ...
      <p>For more icons, please refer to the <a href="https://fontawesome.com/icons?d=gallery&s=regular">Regular icon gallery</a></p>
      <h2>Brand</h2>
      ...
      <p>For more icons, please refer to the <a href="https://fontawesome.com/icons?d=gallery&s=brands">Brand icon gallery</a></p>
    </>
  ))

...
storiesOf('Iconography/FontAwesomeIcon', module).add('exposed component', () => (
  <UiKitInitializer>
    <h1>FontAwesomeIcon</h1>
    <p>
      <code>{FontAwesomeIcon.name}</code> is not part of UiKit. As UiKit uses it in production mode and to avoid loaded
      several version of font awesome in you application, UiKit exposes this component to your application.
    </p>
    <p>

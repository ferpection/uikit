...
interface PlanningBadgeIconProps extends BadgeProps {}

export const PlanningBadgeIcon: FC<PlanningBadgeIconProps> = ({
  className,
  borderColor = {
    toHex: () => {},
  },
  ...
  return (
    <svg className={className} css={styles} viewBox="0 0 75.17 69.21" xmlns="http://www.w3.org/2000/svg">
      <g>
